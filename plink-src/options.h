...
class par {
 ...
 public:
  ...
  static string hapfilename;
  static bool read_hapfile;
  static int hapfile_coding;
  ...
  static bool output_only_fid;
  static bool output_only_iid;
  ...
  static bool snp_attrib_filter_remove;
  ...
  static bool snp_attrib_assign;
  static string snp_assign_file;
  ...
  static bool lf_search;
  static string lf_search_snp;
  ...
  static bool rtest;
  static bool rtest_weights;
  static bool rtest_ppweights;
  static rTestType rtest_type;
  static string rtest_weight_file;
  static rTestHyp rtest_hyp;
  static double rtest_weight_threshold;
  static bool rtest_glm;
  static double rtest_polycount_threshold;
  static bool pool_input;
  static string poolfile;
  static double rtest_freq_threshold;

  static bool GWiS;
  static int GWiS_SampleSize;
  static string perm_prob_file;
  static bool usePerm;
  static string print_shuffle_file;
};
