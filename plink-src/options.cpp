...
string par::hapfilename = "plink.haps";
bool par::read_hapfile = false;
int par::hapfile_coding = 0;
...
bool par::snp_attrib_assign = false;
string par::snp_assign_file = "";
...
bool par::output_only_fid = false;
bool par::output_only_iid = false;
...
bool par::lf_search = false;
string par::lf_search_snp = "rs0";
...
bool par::dprime                  = false;
bool par::ld_and_freqs            = false;
...
bool par::rtest = false;
bool par::rtest_weights = false;
bool par::rtest_ppweights = false;
string par::rtest_weight_file = "";
rTestHyp par::rtest_hyp = RTEST_1SIDED_HIGH;
double par::rtest_weight_threshold = 1;
bool par::rtest_glm = false;
double par::rtest_polycount_threshold = 0.01;
rTestType par::rtest_type = RTEST_VARIABLE_THRESHOLD;
bool par::pool_input= false;
string par::poolfile = "";
double par::rtest_freq_threshold = 0.01;

bool par::GWiS = false;
bool par::usePerm = false;
int par::GWiS_SampleSize = 1;
string par::perm_prob_file = "";
string par::print_shuffle_file = "";
